...
public static class SeedData
{
    ...
    {
        using var dataContext = new WatchListDataContext(serviceProvider.GetRequiredService<DbContextOptions<WatchListDataContext>>());
    ...
    private static void SeedRating(WatchListDataContext dataContext)
    {
    ...
    private static void SeedMovies(WatchListDataContext dataContext)
    {
    ...
    private static void SeedTvShows(WatchListDataContext dataContext)
    {
    ...
    private static void SeedTheatricalPerformances(WatchListDataContext dataContext)
    {
